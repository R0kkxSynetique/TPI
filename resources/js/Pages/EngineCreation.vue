            ...
            <div>
                ...
                <div v-if="form.engine.type == 'thermique'">
                    ...
                    <div class="flex items-center w-full">
                        ...
                        <div class="absolute right-0 px-8 py-5">cc</div>
                    </div>
                </div>
                <div>
                    <p>Fréquence:</p>
                    <div class="flex items-center w-full">
                        <input
                            ...
                            maxlength="25"
                            max="50000"
                            :placeholder="form.engine.type == 'thermique' ? '4 temps ou 4t' : '1140'"
                            class="w-full p-0 py-2 border-t-0 border-l-0 border-r-0 border-b-app focus:ring-0" />
                        <div v-if="form.engine.type == 'électrique'" class="absolute right-0 px-8 py-5">kV</div>
                    </div>
                </div>
                <div>
                    ...
                    <div class="flex items-center w-full">
                        <input
                            ...
                            maxlength="50"
                            :placeholder="form.engine.type == 'thermique' ? '95 SP 3.3%' : 'Lipo 4S'"
                            class="w-full p-0 py-2 border-t-0 border-l-0 border-r-0 border-b-app focus:ring-0" />
                    </div>
                </div>
                <div>
